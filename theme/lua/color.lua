...
function M.setup(opts)
	...
	Group.new("StatusLine", colors.white, colors.base02, styles.reverse)
	Group.new("StatusLineNC", colors.white, colors.base02, styles.reverse)
	...
	Group.new("LineNr", colors.green, bg_color, styles.NONE)
	Group.new("CursorLine", colors.none, colors.yay, styles.NONE, colors.base1)
	Group.new("CursorLineNr", colors.red, colors.yay, styles.NONE, colors.green)
	...
	Group.new("CmpItemKindText", colors.red, colors.none, styles.none)
